...
export default function CollegeConfigScreen() {
  ...
  const handleAddCollege = () => {
    ...
    const config: Omit<CollegeConfig, 'id'> = {
      ...
      featureFlags: {
        ...
        performanceInsights: newCollege.performanceInsights,
      },
      selectors: {
        attendance: '',
        assignments: '',
  ...
  const features = ['attendance', 'assignments', 'notifications', 'timetable', 'cgpa', 'performanceInsights'] as FeatureKey[]
