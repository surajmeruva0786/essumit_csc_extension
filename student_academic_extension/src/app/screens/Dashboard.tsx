...
import { CalendarCheck, Bell, BookOpen, Settings, BarChart3, Clock, GitCompare, Bookmark } from 'lucide-react'
...
const widgets = [
  ...
  { title: 'Smart Bookmarks', desc: 'Bookmarked notices and circulars', icon: Bookmark, to: '/bookmarks', color: 'text-yellow-500' },
]
