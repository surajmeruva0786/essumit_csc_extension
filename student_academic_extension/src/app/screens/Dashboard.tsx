...
import { CalendarCheck, Bell, BookOpen, Settings, BarChart3, Clock, GitCompare, Search } from 'lucide-react'
...
const widgets = [
  ...
  { title: 'Portal Search', desc: 'Search notices, assignments, circulars', icon: Search, to: '/search', color: 'text-indigo-500' },
]
