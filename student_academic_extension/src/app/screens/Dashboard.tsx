...
import { CalendarCheck, Bell, BookOpen, Settings, BarChart3, Clock, GitCompare, Calendar } from 'lucide-react'
...
const widgets = [
  ...
  { title: 'Upcoming Events', desc: 'Countdown to exams and deadlines', icon: Calendar, to: '/countdown', color: 'text-violet-500' },
]
