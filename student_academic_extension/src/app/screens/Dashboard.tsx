...
import { CalendarCheck, Bell, BookOpen, Settings, BarChart3, Clock, GitCompare, Download } from 'lucide-react'
...
const widgets = [
  ...
  { title: 'Downloads', desc: 'Recently downloaded resources', icon: Download, to: '/downloads', color: 'text-yellow-500' },
]
