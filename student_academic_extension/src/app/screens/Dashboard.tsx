...
import { CalendarCheck, Bell, BookOpen, Settings, BarChart3, Clock, GitCompare, WifiOff } from 'lucide-react'
...
const widgets = [
  ...
  { title: 'Offline Access', desc: 'View cached academic data', icon: WifiOff, to: '/offline', color: 'text-gray-500' },
]
