...
import { CalendarCheck, Bell, BookOpen, Settings, BarChart3, Clock, GitCompare, FileText } from 'lucide-react'
...
const widgets = [
  ...
  { title: 'Export PDF', desc: 'Attendance and marks summary', icon: FileText, to: '/export-pdf', color: 'text-amber-500' },
]
