...
import { Home, CalendarCheck, Bell, BookOpen, BarChart3, Clock, GitCompare, Settings, Sliders } from 'lucide-react'
...
const navItems = [
  ...
  { path: '/college-config', label: 'College Config', icon: Sliders },
]
