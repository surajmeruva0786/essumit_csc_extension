        ...
        <div className="bg-surface rounded-lg p-6 border border-border-custom shadow-sm">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-muted-text">
              Digital India service delivery platform
            </p>
          </div>
          ...
          <p className="text-xs text-muted-text mb-5 px-1">
          ...
          <button
            ...
            className="w-full h-11 rounded-md bg-surface border border-border-strong hover:bg-slate-50 text-navy font-medium text-sm flex items-center justify-between px-4 transition-colors"
          >
            <div className="flex items-center gap-2.5">
          ...
          <p className="text-xs text-muted-text mt-3 px-1">
            Chat with AI Assistant
          </p>

          {/* Footer */}
          <div className="mt-8 pt-5 border-t border-border-custom text-center">
